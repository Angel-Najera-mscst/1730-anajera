...
namespace anajera2h1
{
    public partial class _Default : Page
    {
        ...
        protected void DateCalculationButton_Click(object sender, EventArgs e)
        {
            ...
            TextBox6dResult.Text = Ex2hCalculation.DateCalc06(TextBox6a.Text, TextBox6b.Text, TextBox6c.Text);
            TextBox7bResult.Text = Ex2hCalculation.DateCalc07(TextBox7a.Text);
            TextBox9cResult.Text = Ex2hCalculation.DateCalc09(TextBox9a.Text, TextBox9b.Text);
            TextBox10cResult.Text = Ex2hCalculation.DateCalc10(TextBox10a.Text, TextBox10b.Text);
        }
